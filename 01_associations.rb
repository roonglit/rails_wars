# ----------------------------------------------------------------------------
# Challenge 01 — Associations — runner (schema + tests)
#
# DO NOT EDIT THIS FILE. Your work goes in models/01_associations.rb —
# the brief is there too. Run with:  ruby 01_associations.rb
#
...
require_relative "models/01_associations"
